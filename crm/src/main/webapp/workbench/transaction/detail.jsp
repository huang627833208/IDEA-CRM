...
<script type="text/javascript">
	...
	function changeStage(listStage,i) {
		...
		$.ajax({
			...
			data : {
				...
				"id" : "${t.id}",	//tbl_tran表修改用 tbl_tran_history表添加用
				"stage" : listStage,	//tbl_tran表修改用 tbl_tran_history表添加用
				"money" : "${t.money}",	//tbl_tran_history表添加用
				"expectedDate" : "${t.expectedDate}"	//tbl_tran_history表添加用
	...
	function changeIcon(listStage,index1) {
		...
		//如果当前阶段可能性为0 前7个一定是黑圈，后两个一个是红叉，一个是黑叉
