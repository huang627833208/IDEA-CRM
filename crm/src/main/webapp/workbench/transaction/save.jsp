		...
		$(function () {
			...
			$("#create-stage").change(function () {
				...
				/*
					...
					我们以上代码已经成功的取得了选中的阶段
					阶段和可能性之间的对应关系我们也有pMap，虽然我们现在有这个pMap，但是这个集合是java中的，js用不了
					我们现在需要将java的pMap转换为js中的键值对关系json
															{"01资质审查":10,"02需求分析":25....}
				...
				/*
					...
					以上以json.key的形式来取value不行了
					因为我们的key（stage）是我们在前端动态选中的（这是一个变量）
					如果是这样的情况，我们必须以json[key]的形式来取得value
	...
	<form action="workbench/transaction/save.do" method="post" id="tranForm" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="2d02619718a2490b8f3ab86caa9bf214" name="activityId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="d2faa3f0d9d14571ad3030c58e78ed6a" name="contactsId">
			</div>
		</div>
